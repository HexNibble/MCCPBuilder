...
public partial class LoginWindow : Window
{
    ...
    private readonly bool _showMinecraftPurchase;
        ...
        bool isTestChannel)
    {
        ...
        _showMinecraftPurchase = showMinecraftPurchase;
    ...
    private void UpdateProviderUi()
    {
        ...
        RegisterButton.Visibility = type.Equals("UnifiedPassport", StringComparison.OrdinalIgnoreCase)
            ? Visibility.Visible
            : Visibility.Collapsed;
        PurchaseMinecraftButton.Visibility =
            _showMinecraftPurchase &&
            type.Equals("Microsoft", StringComparison.OrdinalIgnoreCase)
                ? Visibility.Visible
                : Visibility.Collapsed;
        if (CanUseSavedLogin())
    ...
    private void PurchaseMinecraft_Click(object sender, RoutedEventArgs e) =>
